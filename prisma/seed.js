// ============================================
// FinanSaku Database Seed
// Pre-populates core tables with initial reference data
// --------------------------------------------
// Notes:
// - Uses Prisma Client to connect to Supabase PostgreSQL
// - Loads environment variables via dotenv
// - Inserts base City, UMK, Template, and Demo User
// - Safe to re-run (uses upsert or existence checks)
// ============================================
...
async function main() {
  ...
  // 3️⃣ Create demo AllocationTemplate
