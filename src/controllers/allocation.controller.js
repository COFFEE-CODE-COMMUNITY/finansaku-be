...
export const getAllAllocations = async (req, res) => {
  try {
    ...
    return success(res, "List of allocations", result)
  } catch (err) {
...
export const getAllocationById = async (req, res) => {
  try {
    ...
    return success(res, "Allocation found", result)
  } catch (err) {
    const status = err.statusCode || 500
...
export const createAllocation = async (req, res) => {
  try {
    ...
    return success(res, "Allocation created", result, 201)
  } catch (err) {
...
export const updateAllocation = async (req, res) => {
  try {
    ...
    if (!result) return fail(res, "Allocation not found", 404)
    return success(res, "Allocation updated", result)
  } catch (err) {
    const status = err.statusCode || 400
...
export const deleteAllocation = async (req, res) => {
  try {
    ...
    if (!result) return fail(res, "Allocation not found", 404)
    return success(res, "Allocation deleted", result)
  } catch (err) {
    const status = err.statusCode || 400
...
export const distributeAllocation = async (req, res) => {
  try {
    ...
    return success(res, "Budget distributed successfully", result)
  } catch (err) {
    const status = err.statusCode || 400
